...
if(primaryNav&&!primaryNav.querySelector('.nav-dropdown')){
 ...
 if(pr)primaryNav.insertBefore(menu('Merchants',[['Merchant resources','merchants.html'],['Registration','registration.html'],['U.S. Portal','https://portal.yolkpay.com/',1],['Canada Portal','https://portal.bookiy.com/',1]]),pr);
}
